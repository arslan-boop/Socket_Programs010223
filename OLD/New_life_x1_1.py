...
def parametre_ata():
    ...
    v_volume_fark_oran, v_oran, v_kar_oran, v_zarar_oran, minVolumePerc,v_program_tip = dosyadan_parametreleri_oku()
...
if __name__ == '__main__':
    ...
    v_zarar_oran, minVolumePerc, v_test_prod, v_ziplama_oran, v_mum_sayisi, v_dalga_oran, v_bakiye ,v_program_tip= parametre_ata()
    ...
    try:
        while True:
            ...
            vm = 'Program Tipi = '+str(v_program_tip)+'  İlk Başladı.........' + str(datetime.now())
            Telebot_v1.mainma(vm)
            print(vm)
            ...
            while True:
                ...
                vm = 'Program Tipi = '+str(v_program_tip)+'İşlem Yapacağı Coinler........' + str(len(v_dosya_coin)) + '-' + \
                ...
                with concurrent.futures.ProcessPoolExecutor(max_workers=v_maxw) as executer:
                    results = [executer.submit(main_islem, v_dosya_coin[p], v_limit_g, v_inter_g, v_islem_tutar,
                                               ...
                                               v_dalga_oran, v_bakiye,v_program_tip) for p
                               in
